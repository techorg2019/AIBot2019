    ...
    public class SNOWLogger
    {
        ...
        public string CreateIncidentServiceNow(string shortDescription, string description, string incpriority)
        {
            try
            {
                ...
                string url = "https://dev81115.service-now.com/api/now/table/"; // Configuration["ServiceNowUrl"];
        ...
        public apiresult KBSearchServiceNow(string shortDescription)
        {
            try
            {
                ...
                //client.BaseAddress = new Uri("https://dev81115.service-now.com");
                ...
                HttpWebRequest request = WebRequest.Create("https://dev81115.service-now.com/api/now/table/kb_knowledge?sysparm_query=" + shortDescription + "&sysparm_fields=number,short_description,text&sysparm_limit=10") as HttpWebRequest;

                //https://dev81115.service-now.com/api/now/table/kb_knowledge?sysparm_query=GOTO123TEXTQUERY321%3Dlaptop&sysparm_limit=10
                request.Headers.Add("Authorization", auth);
        ...
        internal apiresult KBSearchByNumber(string kbnumber)
        {
            try
            {
               ...
               // string username = Configuration["ServiceNowUserName"];
                ...
                HttpWebRequest request = WebRequest.Create("https://dev81115.service-now.com/api/now/table/kb_knowledge?number=" + kbnumber.ToUpper() + "&sysparm_fields=number,short_description,text&sysparm_limit=10") as HttpWebRequest;
        ...
        internal Incident_api_result GetIncident(string INCnumber)
        {
            try
            {
                ...
                HttpWebRequest request = WebRequest.Create("https://dev81115.service-now.com/api/now/table/incident?sysparm_query=GOTOnumber=" + INCnumber + "&sysparm_limit=1") as HttpWebRequest;

                //https://dev81115.service-now.com/api/now/table/kb_knowledge?sysparm_query=GOTO123TEXTQUERY321%3Dlaptop&sysparm_limit=1
                request.Headers.Add("Authorization", auth);
                request.Headers.Add("Content-Type", "application/json");
                request.Headers.Add("Accept", "application/json");
                ...
                Incident_api_result GetIncidentipdate(string sys_id)
                {
                    ...
                    try
                    {
                        ...
                        HttpWebRequest requestforIncstatus = WebRequest.Create("https://dev81115.service-now.com/api/now/table/sys_journal_field?sysparm_query=element_id=" + sys_id + "&sysparm_limit=1") as HttpWebRequest;
            ...
            try
            {
                ...
                string CommentIncidentipdate(string sys_id, string commentit)
                {
                    ...
                    try
                    {
                        ...
                        string password = "Passw0rd!"; // Configuration["ServiceNowPassword"];
                        string url = "https://dev81115.service-now.com/api/now/table/incident/"; // Configuration["ServiceNowUrl"];
